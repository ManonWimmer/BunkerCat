...
public class GamepadCursorMenu : MonoBehaviour
{
    // ----- VARIABLES ----- //
    ...
    public static GamepadCursorMenu instance;
    ...
    public static GamepadCursorMenu GetInstance()
    {
        return instance;
    }
    ...
    private void UpdateMotion()
    {
        ...
        if (previousMouseState != aButtonPressed && InputManager.GetInstance().GetDevice() != "Keyboard" && cursor.activeSelf)
        {
            Debug.Log("ici");
