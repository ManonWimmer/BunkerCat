...
public class LightLaserManager : MonoBehaviour
{
    ...
    private GameObject waypointTop;
    private GameObject waypointBottom;
    ...
    public void Start()
    {
        ...
        waypointTop = waypointFollower.waypoints[0];
        waypointBottom = waypointFollower.waypoints[1];

        _maxHeight = waypointTop.transform.position.y;
        _minHeight = waypointBottom.transform.position.y;
    }
    ...
    public void PlayerInSight(Vector2 playerPosition)
    {
        ...
        // Re check si player s'est pas caché entre temps ?
    }
